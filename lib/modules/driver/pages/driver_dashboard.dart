...
import 'package:laundry_service/modules/driver/pages/driver_crud/driver_task_page_home.dart';
...
class _DriverDashboardState extends State<DriverDashboard> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> bottomBarPages = [
      ...
      const DriverCollectionDeliveryHistory(),
      //DriverProfile(),
      const CampusEmployeeProfile()
    ];
