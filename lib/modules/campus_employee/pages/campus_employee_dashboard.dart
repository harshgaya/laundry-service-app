...
import 'package:laundry_service/modules/campus_employee/pages/history/campus_employee_orders_from_warehouse_page.dart';
import 'package:laundry_service/modules/campus_employee/pages/campus_collection_crud/create_collection_page.dart';
import 'package:laundry_service/modules/campus_employee/pages/remarks/remarks_warehouse.dart';

import 'profile/campus_employee_profile.dart';
import 'search/employee_search_untaken_cloths_from_warehouse.dart';
...
class _CampusEmployeeDashboardState extends State<CampusEmployeeDashboard> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> bottomBarPages = [
      ...
      const CampusEmployeeOrderFromWarehouse(),
      const RemarksWarehouse(),
      const CampusEmployeeSearchUntakenClothsFromWarehouse(),
    ];
