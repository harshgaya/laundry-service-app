...
import 'package:laundry_service/modules/campus_employee/pages/campus_collection_crud/final_count_page.dart';
import 'package:laundry_service/modules/widegets/round_button_animate.dart';

import 'add_other_cloth.dart';
              ...
              Obx(() => DropdownButtonFormField<String>(
                    ...
                    onChanged: (String? newValue) {
                      ...
                      setState(() {
                        ...
                        var faculty = campusEmployeeController.facultyList
                            .firstWhere((element) => element.name == newValue!);
                        selectedTeacherId = faculty.uid;
                      });
                    },
                      ...
                      child: RoundButtonAnimate(
                        ...
                        onClick: () {
                          Utils.showDialogPopUp(
                              context: context,
                              function: () {
                                Get.to(() => const AddOtherCloth());
                              },
                              title: 'Finished Adding Faculty Clothes');
                        },
                        image: const Icon(
                          Icons.done,
                          color: Colors.white,
